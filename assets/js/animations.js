...
function initHeroAnimations() {
    ...
    // Animate hero content - subtle slide, no opacity hiding
    tl.from('.hero-left', {
        y: 30,
        duration: 0.5,
    })
...
function initFeatureAnimations() {
    ...
    featureBlocks.forEach((block, i) => {
        ...
        if (isFull) {
            // Full-width governance OS section - subtle slide only, no opacity
            gsap.from(block, {
                scrollTrigger: {
                    trigger: block,
                    start: 'top 85%',
            ...
            // Alternating layout - subtle slide, no opacity hiding
...
/**
 * Additional GSAP animations (guarded against CDN failure)
 */
window.addEventListener('load', () => {
